...
- **AI 场景润色** — 办公/聊天/创作三种场景，通过 DeepSeek 大模型智能优化文案
...
│   ├── lexicon/             # 行业词库系统
│   ├── prompts/             # Prompt 模板管理
│   │   ├── prompt_manager.py    # Prompt 核心管理器
│   │   ├── office_prompts.py    # 办公场景 Prompt
│   │   ├── chat_prompts.py      # 聊天场景 Prompt
│   │   └── creation_prompts.py  # 创作场景 Prompt
│   └── cache/               # 缓存系统
...
7. **发送文字** — 点击优化卡片，文字自动复制到剪贴板，再点击目标输入框即可自动粘贴
8. **创作模式** — 支持多轮对话式创作（小说/项目策划），与 AI 协作完善内容

### 场景说明

- **办公** — 口语转书面语、邮件/周报代写、会议纪要整理，输出严谨专业的 3 个版本
- **聊天** — 添加 emoji/颜文字，语气更生动自然
- **创作** — 多轮对话创作，支持小说构思和项目策划
